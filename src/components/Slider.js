...
class Slider extends Component {
	...
	// когда компонент исчезнет со страницы
	...
	// кнопки авто перелистывания слайдера
	renderPlayStop() {
		let playStop;

		if(this.state.autoplay) {
			playStop = <svg fill="#000" height="24" viewBox="0 0 24 24" width="24">
